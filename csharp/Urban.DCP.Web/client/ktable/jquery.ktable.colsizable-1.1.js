/*
 * jQuery ktable.colsizable plugin
 ...
 *
 * This plugin has been renamed "ktable" due to the original name
 * containing a term that is offensive to some english-speakers.
 */
(function($){

	$.fn.ktable_colsizable = function(o) {
		// default parameters, properties or settings
		o = $.extend({}, $.fn.ktable_colsizable.defaults, o);
		...
		this
			...
			.each(function(index){
				...
				_Cols.length && $(o.dragCells,this)
					.each(function(index){
						if (!$(this).hasClass('ktable-th'))
							$(this).addClass('ktable-th').wrapInner('<div class="ktable-th-text"></div>');
						$('<div class="'+o.classHandler+'" title="'+ o.title+'"></div>')
							...
							.bind( 'dragstart', function(e){ 
								...
								return $(this)
										...
										.css((o.dragProxy)?{
											top:	this.$td.position().top,
											left:	this.$td.position().left,
	...
	$.fn.ktable_colsizable.defaults = {
		...
		namespace :		"ktable-colsizable",
		classHandler :	"ktable-colsizable-handler",
		classDragLine :	"ktable-colsizable-dragLine",
		classDragArea :	"ktable-colsizable-dragArea",
		classMinimized: "ktable-colsizable-minimized",
